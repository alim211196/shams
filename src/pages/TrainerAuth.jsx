            ...
            {languages.map((lang) => (
              ...
              >
                <Paper elevation={0} sx={{ p: 2 }}>
                  {[
                    { key: "trainer_signup", label: "Sign Up" },
                    { key: "trainer_verify_account", label: "Verify Account" },
                    { key: "trainer_login", label: "Login" },
                    {
                      key: "trainer_forgot_password",
                      label: "Forgot Password",
                    },
                    { key: "trainer_verify_code", label: "Verify Code" },
                    { key: "trainer_reset_password", label: "Reset Password" },
                  ].map(({ key, label }) => (
                    <Grid key={key} container spacing={2} sx={{ mb: 2 }}>
                      ...
                      <Grid size={{ xs: 12 }}>
                        ...
                        >
                          ...
                          {hideInArabicFields &&
                            ["trainer_signup", "trainer_login"].includes(
                              key
                            ) && (
                              <>
                                <Grid size={{ xs: 12, md: 4 }}>
